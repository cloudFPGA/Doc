...
htmlhelp_basename = 'cloudFPGAdoc'
...
latex_documents = [
    (master_doc, 'cloudFPGA.tex', 'cloudFPGA Documentation',
     'cloudFPGA team', 'manual'),
]
...
man_pages = [
    (master_doc, 'cloudFPGA', 'cloudFPGA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cloudFPGA', 'cloudFPGA Documentation',
     author, 'cloudFPGA', 'Field programmable gate arrays for the cloud.',
     'Miscellaneous'),
]
