...
clean:
	rm -rf ./doxyoutput/ ./docsrc/cFDK_api/ ./repos_for_Doxygen/cFDK ./repos_for_Doxygen/Dox ./repos_for_Doxygen/cFp_Vitis ./repos_for_Doxygen/cFp_Monolithic ./repos_for_Doxygen/cFp_EchoThemisto
